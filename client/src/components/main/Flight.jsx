...
export default function Flight() {
  ...
  useEffect(() => {
    ...
    const length = coloredPath.getTotalLength();
    coloredPath.style.strokeDasharray = length;
    coloredPath.style.strokeDashoffset = length;
    ...
    window.addEventListener('scroll', () => {
      ...
      // console.log(ratioY);
      // console.log(ratio);
      const draw = length * ratio;
      coloredPath.style.strokeDashoffset = length - draw;
    });
  }, []);
